...
(function($) {
  ...
  var pq = $.paramquery,
    ...
    grid = pq.strings = pq.pqGrid.regional[local] = {
      ...
      strAddColLeft: "Добавить столбец влево",
      strAddColRight: "Добавить столбец справа",
      strAddRow: "Добавить ряд",
      strAddRowAbove: "Добавьте строку выше",
      strAddRowBelow: "Добавьте строку ниже",
      strAddRows: "Добавить {0} ряды",
      ...
      strBorderStyle: "Пограничный стиль",
      strBottom: "Нижний",
      strCancel: "Отмена",
      strClear: "Прозрачный",
      ...
      strFrozenRows: "Замороженные ряды",
      strFullScreen: "Полноэкранный",
      strGroup_header: "Отбросить группу по столбцу",
      strGroup_merge: "Объединить ячейки",
      strGroup_fixCols: "Исправить столбцы",
      strGroup_grandSummary: "Большое резюме",
      strHide: "Скрывать",
      strHideCols: "Скрыть столбцы",
      strHideRows: "Скрыть ряды",
      strHorizontal: "Горизонтальный",
      strInner: "Внутренний",
      strInsertColumn: "Вставьте столбец",
      strInsertRow: "Вставьте ряд",
      strInsertRows: "Вставить {0} ряды",
      strImport: "Импортировать",
      strImportImage: "Импорт изображение",
      strItalic: "Курсив",
      strLeft: "Левый",
      strLink: "Связь",
      strLoading: "Загрузка",
      strLockCells: "Блокировки ячейки",
      strMerge: "Слияние",
      strMenu: {
      ...
      strNone: "Никто",
      strNoRows: "Нет рядов для отображения.",
      ...
      strTP_colPane: "Групповые столбцы",
      strTP_pivot: "Поворотный режим",
      strTP_rowPane: "Групповые ряды",
      strTP_aggPH: "Сбросить столбцы для агрегатов",
      strTP_colPH: "Отбросить столбцы для группировки столбцов",
      strTP_rowPH: "Отбросить столбцы для группировки строк",
      strUpdate: "Обновлять",
      strUnhide: "Невидимый",
