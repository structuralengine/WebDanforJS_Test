...
(function($) {
  ...
  var pq = $.paramquery,
    ...
    grid = pq.strings = pq.pqGrid.regional[local] = {
      strLocal: "hu",
      strAdd: "Új",
      strAddColumn: "Adjon hozzá oszlopot",
      strAddColLeft: "Adja hozzá a bal oldali oszlopot",
      strAddColRight: "Az oszlop hozzáadása jobbra",
      strAddRow: "Sor hozzáadása",
      strAddRowAbove: "Adja hozzá a fenti sort",
      strAddRowBelow: "Adja hozzá az alábbi sort",
      strAddRows: "Adjon hozzá {0} sorokat",
      ...
      strBold: "Bátor",
      strBorder: "Határ",
      strBorderColor: "Határ színe",
      strBorderStyle: "Határstílus",
      strBottom: "Alsó",
      strCancel: "Megszünteti",
      strClear: "Egyértelmű",
      strComment: "Megjegyzés",
      strCondition: "Condition:",
      strConditions: {
        "": "-- Egyik sem --",
        begin: "Azzal kezdődik",
        between: "Közte",
        contain: "Tartalmaz",
        equal: "Egyenlő",
        empty: "Üres",
      ...
      strDeleteRow: "A sor törlése",
      strEdit: "Szerkeszt",
      strExport: "Export",
      strFillColor: "Kitöltőszín",
      strFontSize: "Betűméret",
      strFontFamily: "Betűtípus család",
      strFormat: "Formátum",
      strFrozenCols: "Fagyasztott oszlopok",
      strFrozenRows: "Fagyasztott sorok",
      strFullScreen: "Teljes képernyő",
      strGroup_header: "Drop Group oszloponként",
      strGroup_merge: "Egyesíti a sejteket",
      strGroup_fixCols: "Javítson oszlopokat",
      ...
      strInner: "Belső",
      strInsertColumn: "Beillesztési oszlop",
      strInsertRow: "Beilleszt",
      strInsertRows: "Helyezze be a {0} sorokat",
      strImport: "Behozatal",
      strImportImage: "Import kép",
      strItalic: "Dőlt betű",
      strLeft: "Bal",
      strLink: "Link",
      strLoading: "Betöltés...",
      strLockCells: "Záró cellák",
      strMerge: "Összeolvad",
      strMenu: {
      ...
      strRedo: "Újra felújít",
      strRename: "Átnevez",
      strRight: "Jobb",
      strSearch: "Keresés",
      strSelectAll: "Mindet kiválaszt",
      strSelectedmatches: "{1} találatból {0} kiválasztva",
      strShowCols: "Oszlopok megjelenítése",
      strShowRows: "Sorsokat mutat",
      strTextColor: "Szöveg szín",
      strTop: "Felső",
      strTabRemove: "A {0} tartósan törlődik.\r\n biztos vagy ebben?",
      strTabName: "sheet{0}",
      strTabAdd: "Új lap",
      strTabClose: "Távolítsa el a lemezt",
      strTP_aggPane: "Adalékanyagok",
      strTP_colPane: "Csoportoszlopok",
      strTP_pivot: "Forgatási mód",
      strTP_rowPane: "Csoportos sorok",
      strTP_aggPH: "Dob oszlopok az adalékanyagokhoz",
      strTP_colPH: "Dob oszlopok oszlopcsoportosításhoz",
      strTP_rowPH: "Dob oszlopok a sorcsoportosításhoz",
      strUpdate: "Frissít",
      strUnhide: "Elront",
      strUnderline: "Aláhúzás",
      strUndo: "Visszavonul",
      strUnmerge: "Bántalmaz",
      strVertical: "Függőleges",
      strWrap: "Csomagolási szöveg",
      strFormulas: {
