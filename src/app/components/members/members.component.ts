    ...
    this.columnHeaders.push(
      ...
      },
      {
        ...
        align: 'center', colModel: [
          {
            align: 'center',
            title: `<div id="member-question"><svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            dataType: '', dataIndx: '', sortable: false, width: 80,nodrag: true,
          },
        ],
