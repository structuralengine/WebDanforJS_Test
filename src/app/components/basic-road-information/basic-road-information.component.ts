...
import { InputBasicRoadInformationService } from './basic-road-information.service';
...
@Component({
  selector: 'app-basic-road-information',
  templateUrl: './basic-road-information.component.html',
  styleUrls: ['./basic-road-information.component.scss']
})
export class BasicRoadInformationComponent implements OnInit, OnDestroy {
  ...
  constructor(
    private basic: InputBasicRoadInformationService,
